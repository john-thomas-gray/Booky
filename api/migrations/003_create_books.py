steps = [
    ...
    [
        ...
        INSERT INTO books VALUES
            (1, 'pride and prejudice', 'Jane Austen', 250, 'Romance', 'Penguin', 'A true banger.',
            'https://i.natgeofe.com/k/75ac774d-e6c7-44fa-b787-d0e20742f797/giant-panda-eating_4x3.jpg'),
            (2, 'Django documentation part 9', 'Josh Elder', 5000, 'Reference', 'Hack Reactor', 'Juicy fan fic.',
            'https://www.oregonzoo.org/sites/default/files/styles/16x9_fallback/public/2023-08/H_hippo_0.jpg?h=fbd56c7f&itok=dusljbzS'),
            (3, 'dr. seuss', 'Dr. Seuss', 13, 'Children', 'Seuss Books', 'I do not like green eggs and ham.',
            ...
            (4, 'The Bell Jar', 'Sylvia Plath', 345, 'Novel', 'Barnes & Noble Classics', 'Very sad.',
