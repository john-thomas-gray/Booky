...
function CreateBookForm() {
    ...
    return (
        ...
        <form onSubmit={handleFormSubmit}>
            ...
            <input type="text" value={synopsis} onChange={(e) => setSynopsis(e.target.value)} placeholder="Synopsis" />
            <input type="text" value={coverImgUrl} onChange={(e) => setCoverImgUrl(e.target.value)} placeholder="Cover Img URL" />
